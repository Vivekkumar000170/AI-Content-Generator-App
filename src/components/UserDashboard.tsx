...
const UserDashboard = () => {
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
      ...
      {/* Plan Info */}
      <div className={`bg-gradient-to-r ${getPlanColor(user.plan)} p-4 rounded-xl mb-6`}>
      ...
      <div className="space-y-2">
        <button className="w-full flex items-center space-x-3 p-3 text-gray-300 hover:text-white hover:bg-gray-700/30 rounded-lg transition-all duration-200">
          <Settings className="w-5 h-5" />
          <span>Account Settings</span>
        </button>
        
        {user.plan === 'starter' && (
          <button className="w-full flex items-center space-x-3 p-3 text-purple-400 hover:text-purple-300 hover:bg-purple-500/10 rounded-lg transition-all duration-200">
