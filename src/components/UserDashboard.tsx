...
const UserDashboard = () => {
  ...
  const handleUpgrade = () => {
    ...
    alert('Upgrade Plan - This would open the pricing/upgrade modal in a real application.');
  };

  return (
    <div className="bg-gray-800/30 backdrop-blur-3xl border border-white/10 rounded-2xl p-6 shadow-2xl">
      {/* User Info Header */}
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg backdrop-blur-xl">
        ...
        <button
          ...
          className="p-2 text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-all duration-200 hover:scale-110 backdrop-blur-xl border border-transparent hover:border-red-500/20"
          title="Logout"
        >
      ...
      {/* Plan Info */}
      <div className={`bg-gradient-to-r ${getPlanColor(user.plan)} p-4 rounded-xl mb-6 shadow-lg backdrop-blur-xl`}>
      ...
      <div className="space-y-4 mb-6">
        <div>
          ...
          {user.usage.wordsLimit !== -1 && (
            <div className="w-full bg-gray-700/30 rounded-full h-2 backdrop-blur-xl border border-white/5">
              <div 
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gray-700/20 backdrop-blur-2xl rounded-lg p-3 border border-white/5">
      ...
      <div className="space-y-2">
        <button 
          ...
          className="w-full flex items-center space-x-3 p-3 text-gray-300 hover:text-white hover:bg-gray-700/20 rounded-lg transition-all duration-200 hover:scale-105 backdrop-blur-xl border border-transparent hover:border-white/10"
        >
