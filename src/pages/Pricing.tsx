...
const Pricing = () => {
  const handlePlanSelect = (planName: string) => {
    if (planName === 'Enterprise') {
      ...
      // For other plans, simulate a checkout process
      alert(`Redirecting to secure checkout for ${planName} plan...`);
      // In a real app, you would redirect to your payment processor (Stripe, PayPal, etc.)
